...
namespace RationalNumbers_LR3_Lukoyanov.Tests
{
    public class ContinuedFractionsTests
    {
        ...
        public void FromContinuedFraction()
        {
            ...
            // action
            var rational = Rational.Rational.FromContinuedFraction(continuedFraction);

            // assert
            Assert.Equal((Rational.Rational)43 / 17, rational);
        }
        ...
        public void FromContinuedFraction_Big1()
        {
            ...
            // assert
            Assert.Equal((Rational.Rational)7489051 / 5225670, rational);
        }
        ...
        public void FromContinuedFraction_Big2()
        {
            ...
            // assert
            Assert.Equal((Rational.Rational)7489051 / 740785, rational);
        }
        ...
        public void FromContinuedFraction_LessThanOne()
        {
            ...
            // assert
            Assert.Equal((Rational.Rational)1 / 3, rational);
        }
        ...
        public void FromContinuedFraction_Negative1()
        {
            ...
            // assert
            Assert.Equal((Rational.Rational)(-5421) / 121, rational);
        }
        ...
        public void FromContinuedFraction_Negative2()
        {
            ...
            // assert
            Assert.Equal((Rational.Rational)683 / -12345, rational);
        }
        ...
        public void FromContinuedFraction_One()
        {
            ...
            // assert
            Assert.Equal(Rational.Rational.One, rational);
        }
        ...
        {
            // arrange
            var rational = (Rational.Rational)43 / 17;
        ...
        {
            // arrange
            var rational = (Rational.Rational)7489051 / 5225670;
        ...
        {
            // arrange
            var rational = (Rational.Rational)7489051 / 740785;
        ...
        {
            // arrange
            var rational = (Rational.Rational)1 / 3;
        ...
        {
            // arrange
            var rational = (Rational.Rational)(-5421) / 121;
        ...
        {
            // arrange
            var rational = (Rational.Rational)683 / -12345;
        ...
        {
            // arrange
            var rational = Rational.Rational.One;
        ...
        {
            // arrange
            var rational = Rational.Rational.Zero;
