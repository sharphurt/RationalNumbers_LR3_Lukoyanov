...
namespace RationalNumbers_LR3_Lukoyanov.Tests
{
    public class ExplicitFloatingPointConversionsTests
    {
        ...
        {
            // action
            var rational = (Rational.Rational)input;

            // assert
            Assert.Equal((Rational.Rational)expectedNumerator / expectedDenominator, rational);
        }
        ...
        {
            // ReSharper disable once UnusedVariable
            var x = (Rational.Rational)decimal.MaxValue;
        }
        ...
        {
            // ReSharper disable once UnusedVariable
            var x = (Rational.Rational)decimal.MinValue;
        }
        ...
        public void FromDouble_MaxValue_Throws()
        {
            ...
            Assert.Throws<OverflowException>(() =>
            {
                var x = (Rational.Rational)double.MaxValue;
            });
        }
        ...
        public void FromDouble_MinValue_Throws()
        {
            ...
            Assert.Throws<OverflowException>(() =>
            {
                var x = (Rational.Rational)double.MinValue;
            });
        }
        ...
        {
            // arrange
            var rational = (Rational.Rational)1 / 2;
        ...
        {
            // arrange
            var rational = -(Rational.Rational)1 / 6;
        ...
        {
            // arrange
            var rational = (Rational.Rational)4 / -3;
